...
<head>
    ...
    <!-- Page Title -->
    <title>Advice - Health Advice Group</title>
    <!-- Favicon -->
...
<body>
    ...
    <!-- Page Contents -->
    <section>
        <h3 class="page-heading">Advice</h3>

        <div class="accordion-body">
            <p>A range of advice to help you deal with severe weather. Tips and advice on how to stay safe, warm and healthy at home or outdoors.
                All types of weather can affect you, those around you, and your property. Make sure you're prepared by checking our seasonal tips and advice. Find the latest articles here and scroll down for advice on travel, your home and health and wellbeing.</p>
            <br>
            <br>
            <div class="accordion accordion-flush" id="accordionFlushExample">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">Most of us welcome hot weather, but when it's too hot, there are health risks. During heatwaves, more people than usual get seriously ill or die. If hot weather hits this summer, make sure it does not harm you or anyone you know.
                            ...
                            If you or someone else feels unwell with a high temperature during hot weather, it may be heat exhaustion or heatstroke.</div>
                    </div>
                </div>
                <br>
                <!-- New Accordion -->
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">Cold weather can make some health problems worse and even lead to serious complications, especially if you're 65 or older, or if you have a long-term health condition.
                            ...
                            In an emergency, go to A&E immediately or call 999.</div>
                    </div>
                </div>
                <br>
                <!-- New Accordion -->
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingSix" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">When there is a rain warning in place, here are some things you can do...
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">When there is a wind warning in place, here are some things you can do...
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="flush-headingFive">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFive" aria-expanded="false" aria-controls="flush-collapseFive">
                            <h5>Pollen and Hay Fever</h5>
                        </button>
                    </h2>
                    <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">Pollen is a fine powder made up of microscopic pollen grains. Its dispersion and movement in the atmosphere is of great interest to millions of hay fever sufferers around the world.
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="flush-headingSix">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseSix" aria-expanded="false" aria-controls="flush-collapseSix">
                            <h5>Stay safe in thunder and lightning
                            </h5>
                        </button>
                    </h2>
                    <div id="flush-collapseSix" class="accordion-collapse collapse" aria-labelledby="flush-headingSix" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">Learn how to protect yourself in a thunderstorm.
                            ...
                            Hail storms can be extremely dangerous to drive in reducing your ability to see and be seen, as well as causing damage to your vehicle. If hail is severe, stop and pull over to a safe place and remain inside the vehicle</div>
                    </div>
                </div>
            </div>
        </div>
